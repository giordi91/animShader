...
# from animShader.attributes import generic_attr
from animShader.shader_utils import json_utils
from storable_class import st_class
# from storable_class import st_attr
class Matcher(st_class.StorableClass):
    """
    ...
    #                    if issubclass(type(v), generic_attr.GenericAttr)]
    #     return results
